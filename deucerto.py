...
def main():
    ...
    try:
        ...
        query = 'subject:"Você recebeu uma transferência!" OR subject:"Você recebeu uma transferência pelo PIX!" OR subject:"Recebemos sua transferência pelo PIX!"'
        ...
        for message in messages:
            ...
            internal_date = int(msg['internalDate']) / 1000  # Converte de milissegundos para segundos
            email_date = datetime.fromtimestamp(internal_date).strftime('%d %b %Y às %H:%M')
            ...
            if html_content:
                ...
                print(f"Valor: {value}")
                print(f"Data e Hora (do HTML): {date_time}")
                print(f"Data e Hora (do e-mail): {email_date}")
                print('-' * 40)
